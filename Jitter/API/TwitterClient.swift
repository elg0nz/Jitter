...
class TwitterClient: BDBOAuth1SessionManager {
    ...
    func mentions(success: @escaping ([Tweet]) -> Void, failure: @escaping (NSError) -> Void) {
        let PAGE_SIZE = 20
        let cacheKey = "mentionsTimeline" as NSString
    ...
    // TODO: Refactor to remove code duplication
    func userActivity(success: @escaping ([Tweet]) -> Void, failure: @escaping (NSError) -> Void) {
        let PAGE_SIZE = 20
        let cacheKey = "activityTimeline" as NSString
